...
$sql = "SELECT DISTINCT V.arrangementID, CONCAT(IF(AA.isInPads=1,'','*'),V.songName,', ',A.arrangerFirstName, ' ',A.arrangerLastName) FROM view_efilePart AS V, view_arrangement AS A, arrangement AS AA WHERE A.arrangementID=V.arrangementID AND AA.arrangementID=A.arrangementID ORDER BY V.songName ASC";
//echo $sql;
